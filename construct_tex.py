...
if __name__ == "__main__":
    ...
    #remove_chn_tex("洪建路")
    #add_chn_tex("虹建路")
    #remove_eng_tex("Xujingbeicheng")
    #add_eng_tex("Xujing Beicheng")
    #remove_eng_tex("International Curise Terminal")
    #add_eng_tex("International Cruise Terminal")
    #remove_chn_tex("T3航站楼")
    #add_chn_tex("浦东机场T3航站楼")
    #remove_eng_tex("Terminal 3")
